...
@CrossOrigin(origins = { "http://localhost", "http://localhost:3000", "https://springrestavion-production.up.railway.app/user",  "https://springrestavion-production.up.railway.app/avions" })
@RestController
